...
namespace NewsWeb.ApplicationBuilder
{
    public static class ContainerManager
    {
        ...
        private static ContainerBuilder BuildContainerInternal()
        {
            ...
            builder.RegisterFromAssembly("NewsWeb.Business", "NewsWeb.Business.BusinessManager");
            builder.RegisterFromAssembly("NewsWeb.Repository", "NewsWeb.Repository.BaseDataContext");
            builder.RegisterFromAssembly("NewsWeb.Repository", "NewsWeb.Repository.ApplicationDbContext");
